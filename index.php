...
{
            ?>
        <div class="p-2 bd-highlight"><strong><a href="#"class="text-white"><?php echo $_SESSION['userusername'];?></a></strong></div>
        <div class="p-2 bd-highlight"><strong><a href="includes/logout.inc.php"class="text-white">LOGOUT</a></strong></div>
        <?php
}
else{
    ?>
